module.exports = {
  'rules': {
    ...
    // enforces no usage of trailing commas
    'comma-dangle': [
      'error',
      'never'
    ],
    ...
    'new-parens': 'error',
    // enforces a style to disallow Array constructors. [DISCUSS]
    ...
    // enforces a style to disallow any spaces inside of parentheses [DISCUSS]
    'space-in-parens': [
      'error',
      'never'
    ],
